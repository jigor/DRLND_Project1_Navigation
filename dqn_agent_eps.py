...
class Agent_eps():
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        self.t_step = (self.t_step + 1) % hyp.UPDATE_EVERY
        if self.t_step == 0:
            # If enough samples are available in memory, get random subset and learn
            if len(self.memory) > hyp.BATCH_SIZE:
    ...
    def learn(self, experiences, gamma):
        ...
        self.soft_update(self.qnetwork_local, self.qnetwork_target, hyp.TAU)                     
